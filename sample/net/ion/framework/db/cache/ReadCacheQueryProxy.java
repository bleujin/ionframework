...
public class ReadCacheQueryProxy implements InvocationHandler {

	private ReadCacheDBController cdbm;
	private IQueryable query;

	public ReadCacheQueryProxy(ReadCacheDBController cdbm, IQueryable query) {
		this.cdbm = cdbm;
		this.query = query;
	}
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		try {
			...
			if (foundCache) {
				...
				cdbm.handleServant(start, end, query, IQueryable.QUERY_COMMAND);
			}
		}
