...
/**
 * Use this as superclass in case you need to be able to be able to notify progress. If you don't need to notify progress, you can simply use {@link Runnable}
 * 
 * @see #notify(Object)
 * @author Ray Tsang
 * 
