...
public interface Promise<D, F, P> {
	 ...
	 *            {@link #progress(ProgressCallback)}
	 * @return
	 */
	...
	/**
	 * If any of the filter is not specified, a default No Op filter would be used. This is also known as "piping", or "chaining" of callbacks and being able to modify the return value.
	 * 
	 * <pre>
	 * <code>
	 ...
	 * 
	 * @param doneFilter
	 *            if null, use {@link NoOpDoneFilter}
	 * @param failFilter
	 *            if null, use {@link NoOpFailFilter}
	 * @param progressFilter
	 *            if null, use {@link NoOpProgressFilter}
	 * @return
	 */
	...
	/**
	 * This method is similar to JQuery's pipe() method, where a new {@link Promise} is returned by the the pipe filter instead of the original. This is useful to handle return values and then rewiring it to different callbacks.
	 * 
	 * <pre>
	 * <code>
	...
	/**
	 * This method will register {@link DoneCallback} so that when a Deferred object is resolved ({@link Deferred#resolve(Object)}), {@link DoneCallback} will be triggered.
	 * 
	 * You can register multiple {@link DoneCallback} by calling the method multiple times. The order of callback trigger is based on the order you call this method.
	 * 
	 * <pre>
	 * <code>
	...
	/**
	 * This method will register {@link FailCallback} so that when a Deferred object is rejected ({@link Deferred#reject(Object)}), {@link FailCallback} will be triggered.
	 * 
	 * You can register multiple {@link FailCallback} by calling the method multiple times. The order of callback trigger is based on the order you call this method.
	 * 
	 * <pre>
	 * <code>
	...
	/**
	 * This method will register {@link AlwaysCallback} so that when it's always triggered regardless of whether the corresponding Deferred object was resolved or rejected.
	 * 
	 * You can register multiple {@link AlwaysCallback} by calling the method multiple times. The order of callback trigger is based on the order you call this method.
	 * 
	 * <pre>
	 * <code>
	...
	/**
	 * This method will register {@link ProgressCallback} so that when a Deferred object is notified of progress ({@link Deferred#notify(Object)}), {@link ProgressCallback} will be triggered.
	 * 
	 * You can register multiple {@link ProgressCallback} by calling the method multiple times. The order of callback trigger is based on the order you call this method.
	 * 
	 * <pre>
	 * <code>
	...
	/**
	 * This method will wait as long as the State is Pending. This method will fail fast when State is not Pending.
	 * 
	...
	/**
	 * This method will wait when the State is Pending, and return when timeout has reached. This method will fail fast when State is not Pending.
	 * 
	 * @throws InterruptedException
	 */
