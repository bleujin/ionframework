...
/**
 * A fast iterator for concatenated ropes. Iterating over a complex rope structure is guaranteed to be O(n) so long as it is reasonably well-balanced. Compare this to O(nlogn) for iteration using <code>charAt</code>.
 * 
 * @author aahmad
 */
