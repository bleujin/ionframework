...
/**
 * A fast reverse iterator for concatenated ropes. Iterating over a complex rope structure is guaranteed to be O(n) so long as it is reasonably well-balanced. Compare this to O(n log n) for iteration using <code>charAt</code>.
 * 
 * @author aahmad
 */
