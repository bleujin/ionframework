...
public class LinkedCaseInsensitiveMap<V> extends LinkedHashMap<String, V> {
	...
	/**
	 * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with the given initial capacity and stores lower-case keys according to the default Locale.
	 * 
	...
	/**
	 * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with the given initial capacity and stores lower-case keys according to the given Locale.
	 * 
	 * @param initialCapacity
	 *            the initial capacity
	 * @param locale
