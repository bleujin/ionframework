 ...
 * 
 * This class exists to stream stringbuilders without copies. Just copied the (open)jdk class StringBufferReader and did some alterations.
 */
public class StringBuilderReader extends Reader {
	 ...
	 * 
	 * <p>
	 * The <code>ns</code> parameter may be negative, even though the <code>skip</code> method of the {@link Reader} superclass throws an exception in this case. Negative values of <code>ns</code> cause the stream to skip backwards. Negative return
