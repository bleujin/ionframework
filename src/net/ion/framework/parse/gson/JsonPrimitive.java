...
public final class JsonPrimitive extends JsonElement {
	...
	private static final Class<?>[] PRIMITIVE_TYPES = { int.class, long.class, short.class, float.class, double.class, byte.class, boolean.class, char.class, Integer.class, Long.class, Short.class, Float.class, Double.class, Byte.class, Boolean.class, Character.class };
	...
	/**
	 * Create a primitive using the specified Object. It must be an instance of {@link Number}, a Java primitive type, or a String.
	 * 
	 * @param primitive
	 *            the value to create the primitive with.
	 */
