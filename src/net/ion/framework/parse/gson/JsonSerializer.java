...
/**
 * Interface representing a custom serializer for Json. You should write a custom serializer, if you are not happy with the default serialization done by Gson. You will also need to register this serializer through {@link net.ion.framework.parse.gson.GsonBuilder#registerTypeAdapter(Type, Object)}.
 * 
 * <p>
 ...
 * 
 * <p>
 * The default serialization of {@code Id(com.foo.MyObject.class, 20L)} will be <code>{"clazz":com.foo.MyObject,"value":20}</code>. Suppose, you just want the output to be the value instead, which is {@code 20} in this case. You can achieve that by writing a custom serializer:
 * </p>
 * 
 * <p>
 * 
 ...
 * 
 * @param <T>
 *            type for which the serializer is being registered. It is possible that a serializer may be asked to serialize a specific generic type of the T.
 */
