...
import net.ion.framework.parse.gson.JsonIOException;
import net.ion.framework.parse.gson.JsonPrimitive;
import net.ion.framework.parse.gson.JsonSyntaxException;
import net.ion.framework.parse.gson.TypeAdapter;
import net.ion.framework.parse.gson.TypeAdapterFactory;
import net.ion.framework.parse.gson.internal.$Gson$Types;
...
import net.ion.framework.parse.gson.internal.ObjectConstructor;
 ...
 * 
 * <h3>Maps as JSON objects</h3> For primitive keys or when complex map key serialization is not enabled, this converts Java {@link Map Maps} to JSON Objects. This requires that map keys can be serialized as strings; this is insufficient for some key types. For example, consider a map whose keys are points on a grid. The default JSON form encodes reasonably:
 * 
 * <pre>
 * @code
