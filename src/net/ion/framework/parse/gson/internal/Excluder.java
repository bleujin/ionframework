...
import net.ion.framework.parse.gson.ExclusionStrategy;
import net.ion.framework.parse.gson.FieldAttributes;
...
import net.ion.framework.parse.gson.annotations.Until;
