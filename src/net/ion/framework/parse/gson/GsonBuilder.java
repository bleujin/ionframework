...
public final class GsonBuilder {
	 ...
	 * 
	 * @param modifiers
	 *            the field modifiers. You must use the modifiers specified in the {@link java.lang.reflect.Modifier} class. For example, {@link java.lang.reflect.Modifier#TRANSIENT}, {@link java.lang.reflect.Modifier#STATIC}.
	 * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
	 */
	...
	/**
	 * Configures Gson to exclude all fields from consideration for serialization or deserialization that do not have the {@link net.ion.framework.parse.gson.annotations.Expose} annotation.
	 * 
	 * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
	 */
	 ...
	 *            the JSON field naming convention to use for serialization and deserialization.
	 * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
	 */
	 ...
	 * skipped during its deserialization.
	 * 
	 * @param strategy
	 ...
	 * 
	 * @param style
	 *            the predefined date style that date objects will be serialized/deserialized to/from
	 * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
	 * @since 1.2
	 */
	...
	/**
	 * Configures Gson for custom serialization or deserialization. This method combines the registration of an {@link TypeAdapter}, {@link InstanceCreator}, {@link JsonSerializer}, and a {@link JsonDeserializer}. It is best used when a single object {@code typeAdapter} implements all the required interfaces for custom serialization with Gson. If a type adapter was previously registered for the
	 * specified {@code type}, it is overwritten.
	 * 
	 * @param type
	 *            the type definition for the type adapter being registered
	 * @param typeAdapter
	 *            This object must implement at least one of the {@link TypeAdapter}, {@link InstanceCreator}, {@link JsonSerializer}, and a {@link JsonDeserializer} interfaces.
	 * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
	 */
	 ...
	 * be invoked instead of the one registered for the type hierarchy.
	 * 
	 * @param baseType
	 *            the class definition for the type adapter being registered for the base class or interface
	 * @param typeAdapter
	 *            This object must implement at least one of {@link TypeAdapter}, {@link JsonSerializer} or {@link JsonDeserializer} interfaces.
	 * @return a reference to this {@code GsonBuilder} object to fulfill the "Builder" pattern
	 * @since 1.7
	 */
	@SuppressWarnings( { "unchecked", "rawtypes" })
	...
	/**
	 * Section 2.4 of <a href="http://www.ietf.org/rfc/rfc4627.txt">JSON specification</a> disallows special double values (NaN, Infinity, -Infinity). However, <a href="http://www.ecma-international.org/publications/files/ECMA-ST/Ecma-262.pdf">Javascript specification</a> (see section 4.3.20, 4.3.22, 4.3.23) allows these values as valid Javascript values. Moreover, most JavaScript engines will
	 * accept these special values in JSON without problem. So, at a practical level, it makes sense to accept these values as valid JSON even though JSON specification disallows them.
	 * 
	 * <p>
	 * Gson always accepts these special values during deserialization. However, it outputs strictly compliant JSON. Hence, if it encounters a float value {@link Float#NaN}, {@link Float#POSITIVE_INFINITY}, {@link Float#NEGATIVE_INFINITY}, or a double value {@link Double#NaN}, {@link Double#POSITIVE_INFINITY}, {@link Double#NEGATIVE_INFINITY}, it will throw an {@link IllegalArgumentException}.
