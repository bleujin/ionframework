...
/**
 * An enumeration that defines a few standard naming conventions for JSON field names. This enumeration should be used in conjunction with {@link net.ion.framework.parse.gson.GsonBuilder} to configure a {@link net.ion.framework.parse.gson.Gson} instance to properly translate Java field names into the desired JSON field names.
 * 
...
public enum FieldNamingPolicy implements FieldNamingStrategy {
	 ...
	 * <li>aURL ---> a-u-r-l</li>
	 * </ul>
	 * Using dashes in JavaScript is not recommended since dash is also used for a minus sign in expressions. This requires that a field named with dashes is always accessed as a quoted property like {@code myobject['my-field']}. Accessing it as an object field {@code myobject.my-field} will result in an unintended javascript expression.
	 * 
	 * @since 1.4
	 */
