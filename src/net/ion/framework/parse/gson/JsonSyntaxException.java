...
public final class JsonSyntaxException extends JsonParseException {
	...
	/**
	 * Creates exception with the specified cause. Consider using {@link #JsonSyntaxException(String, Throwable)} instead if you can describe what actually happened.
	 * 
	 * @param cause
