 ...
 * 
 * <p>
 * As with type adapters, factories must be <i>registered</i> with a {@link net.ion.framework.parse.gson.GsonBuilder} for them to take effect:
 * 
 * <pre>
 * @code
 * 
 ...
 * In this example we implement a factory for Guava's {@code Multiset} collection type. The factory can be used to create type adapters for multisets of any element type: the type adapter for {@code Multiset<String>} is different from the type adapter for {@code Multiset<URL>}.
 * 
 * <p>
