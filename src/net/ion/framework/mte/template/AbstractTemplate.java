...
public abstract class AbstractTemplate implements Template {
	 ...
	 * @param modelAdaptor
	 *            adaptor used for this transformation to look up values from model
	...
	public String transform(Map<String, Object> model, Locale locale, ProcessListener processListener) {
		return transform(model, locale, engine.config().modelAdaptor(), processListener);
	}
	...
	public String transform(Map<String, Object> model, Locale locale) {
		return transform(model, locale, engine.config().modelAdaptor(), null);
	}
