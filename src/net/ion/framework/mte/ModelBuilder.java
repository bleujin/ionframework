...
public final class ModelBuilder {
	...
	/**
	 * Transforms an array to a model using the index of the elements (starting from 1) in the array and a prefix to form their names.
	 * 
	 * @param prefix
	 *            the prefix to add to the index or <code>null</code> if none shall be applied
	 * @param args
