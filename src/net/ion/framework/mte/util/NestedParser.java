...
public final class NestedParser {
	...
	public static String access(final List<? extends Object> ast, final int index, final String defaultValue) {
		if (ast == null) {
			return defaultValue;
		}
		...
		if (operators.size() != 0) {
			...
			if (innerLoop) {
				...
				for (String segment : segments) {
					List<Object> parse = parse(segment, operators.subList(1, operators.size()));
